    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="/toko/form" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Register toko</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/kat_toko/form" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>register kategori toko</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2022-2030 <a href="https://adminlte.io">Galang</a>.</strong> All rights
                reserved.
            </footer>
